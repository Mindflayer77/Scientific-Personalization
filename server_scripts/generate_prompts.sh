...
#SBATCH --mem=128gb
#SBATCH --time=0-01:30:00    # format dd-hh:mm:ss np. 1-12:30:15
#SBATCH --job-name=prompts_generation
#SBATCH --output=out/prompt_generation-test.out
...
export FLASHINFER_JIT_DIR=$MY_DISK/$CACHE_DIR/flashinfer
...
while true; do nvidia-smi > out/nvidia_smi-test.log 2>&1; sleep 5; done &
WATCH_PID=$!
...
python3 scripts/dataset_generation/generate_prompts.py
