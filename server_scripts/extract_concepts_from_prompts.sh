...
#SBATCH --job-name=extract_concepts
#SBATCH --output=out/extract_concepts-test.out
...
echo "Starting Concept Extraction..."
python3 scripts/dataset_generation/extract_concepts_from_prompts.py
